...
public interface GreeterService {
  ...
  public static class Serializers {
      ...
      public static ProtobufSerializer<com.example.helloworld.HelloRequest> HelloRequestSerializer = new GoogleProtobufSerializer<>(com.example.helloworld.HelloRequest.class);
    
      public static ProtobufSerializer<com.example.helloworld.HelloReply> HelloReplySerializer = new GoogleProtobufSerializer<>(com.example.helloworld.HelloReply.class);
